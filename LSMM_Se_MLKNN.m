...
parfor fold = 1 : num_fold
    ...
    % MLKNN is coupled with LSMMSE: MLKNN-LSMMSE
    [Prior_LSMMSE, PriorN_LSMMSE, Cond_LSMMSE, CondN_LSMMSE] = MLKNN_LSMM_Se_train(train_data, train_target, para, L);
    [Outputs_LSMMSE, Pre_Labels_LSMMSE] = MLKNN_LSMM_Se_predict(test_data, train_data, train_target, para.num_MLKNN_neighbour, Prior_LSMMSE, PriorN_LSMMSE, Cond_LSMMSE, CondN_LSMMSE, L);
    [HammingLoss_LSMMSE, RankingLoss_LSMMSE, Coverage_LSMMSE, Average_Precision_LSMMSE, MicroF1_LSMMSE, MacroAUC_LSMMSE] = MLEvaluate(Outputs_LSMMSE, Pre_Labels_LSMMSE, test_target);
    Result_LSMMSE(fold,:) = [HammingLoss_LSMMSE, RankingLoss_LSMMSE, Coverage_LSMMSE, Average_Precision_LSMMSE, MicroF1_LSMMSE, MacroAUC_LSMMSE];
...
% Print results of MLKNN-LSMMSE
fprintf('MLKNN-LSMMSE results:\n');
fprintf(' %12s  %12s  %12s  %8s %12s  %12s\n','HammingLoss↓', 'RankingLoss↓', 'Coverage↓','Average_Precision↑', 'MacroF1↑', 'MacroAUC↑');
